...
const suggestedQuestionKeys = {
  'en-US': ['introduceEvent', 'introduceTeams', 'copilotAgenda', 'introduceLiteon'],
  'zh-TW': ['introduceEvent', 'introduceTeams', 'copilotAgenda', 'introduceLiteon'],
}

const i18nMap = {
  "en-US": {
    "headerTitle": "AI Empowering the Future of Smart Work",
    ...
    "introduceLiteon": "Please introduce Liteon in 50 words",
    // "login": {
...
//
// Function to generate text and be sent as prompt to the API, show the history in the chat
//
